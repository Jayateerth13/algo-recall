      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">
            Capture everything you need to remember this problem&apos;s pattern
            and solution. Designed for fast, focused entry.
          </p>
        </div>
        <button
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[11px] text-slate-400">
                  Comma‑separated for now. We can upgrade this to chips later.
                </p>
              </div>
            </div>
          </section>
          ...
          <div className="flex items-center justify-between border-t border-slate-100 pt-4">
            <p className="text-[11px] text-slate-400">
              You can always refine notes later. Capture the core pattern first.
            </p>
